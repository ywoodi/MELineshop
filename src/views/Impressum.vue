  ...
  <main class="impressum">
    ...
    <section>
      ...
      <p>
        ...
        Zuständige Aufsichtsbehörde gem. E-Commerce-Gesetz: Magistrat der Stadt Linz<br />
        Kammerzugehörigkeit: Wirtschaftskammer Oberösterreich, Fachgruppe der Lebensmittelgewerbe
      </p>
    </section>
